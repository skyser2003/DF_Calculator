...
job_detail={
    ...
    '프리스트(여)':{
        '眞 크루세이더':[0,0,1,4093,[''],0,'(버프)세라핌',[''],[''],0], # 조회 불가 직업
        '眞 이단심판관':[3,93,0,4064,[''],7.76,'인페르노',[''],[''],4.14],
        '眞 무녀':[1,108,0,4167,[''],6.61,'천선낭랑',[''],[''],3.33],
        '眞 미스트리스':[12,87.5,0,4098,[''],6.95,'리디머',[''],[''],3.57] # 시너지 (투기에 가득찬 분노)
        },
    '도적':{
